      ...
      <div className="mt-3 overflow-hidden rounded-md border bg-white">
        <table className="w-full table-fixed text-[11px]">
          <thead className="bg-gray-50 border-b">
            <tr>
              <th className="px-1 py-2 text-left font-medium w-[12%]">Courier Dt</th>
              <th className="px-1 py-2 text-left font-medium w-[20%]">Customer</th>
              <th className="px-1 py-2 text-left font-medium w-[12%]">Invoice Dt</th>
              <th className="px-1 py-2 text-center font-medium w-[8%]">Inv</th>
              <th className="px-1 py-2 text-center font-medium w-[8%]">Box</th>
              <th className="px-1 py-2 text-center font-medium w-[12%]">Received</th>
              <th className="px-1 py-2 text-center font-medium w-[10%]">Stock OK</th>
              <th className="px-1 py-2 text-left font-medium w-[18%]">Follow up / Notes</th>
            </tr>
          </thead>
              ...
              rows.map((r) => (
                <tr key={r.feedback_id} className="border-t align-top">
                  ...
                  <td className="px-1 py-2">
                    <textarea
                      className="h-16 w-full resize-none rounded-md border p-1 text-[12px]"
                      value={r._follow_up}
